/**
 * @ Date : 2015.06. @ Author : itbank. @ Story : member.jsp, memberform.jsp 관련
 *   js 파일
 */
...
var login = function() {
                 /*
					 * if(document.frmLogin.id.value.length == 0){ alert("아이디를
					 * 써주세요"); frmLogin.id.focus(); // 커서를 인풋텍스트 칸에 위치시킨다. //
					 * return false; } if(document.frmLogin.password.value ==
